...
!!! tip "Prerequisites"
    ...
    - Debian 12 distribution installed ([installation d’une distribution Linux](./installation-wsl.md)) **or** active MarioNum session ([Intro-MarioNum](./Intro-MarioNum.md)).
